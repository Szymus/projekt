...
int main(int argc, char* argv[])
{
 ...
 cvCreateTrackbar("HighV", "Control", &iHighV, 255);
    ...
    while (1)
    {
		...
		if (iLastX<50 || iLastY<50 || iLastX>590 || iLastY>430)
		{
			putText(frame,"Prosze nie sciagac",Point(1,400),1,2, CV_RGB(255,255,0),4,8,false);
		
		}
		//putText(frame,"textsasxasx",Point(1,400),2,4, CV_RGB(255,255,0),4,8,false);
		imshow("Thresholded Image", imgThresholded); //obraz po konwersji
		frame1=frame+imgLines;
